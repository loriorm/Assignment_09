...
# ormerodl, 2020-Sept-09, Update for the Todos
# ormerodl, 2020-Sept-09, Update save_inventory to for list of file names
# ormerodl, 2020-Sept-09, Update save_inventory to save to file
# ormerodl, 2020-Sept-09, Update load_inventory for list of file names
# ormerodl, 2020-Sept-09, Update load_inventory to load inv
...
class FileIO:
    ...
    def save_inventory(file_name: list, lst_Inventory: list) -> None:
        ...
        try:
            ...
            print('Something went wrong.', e, e.__doc__, type(e), sep='\n')
